        ...
        <div className="flex gap-4 overflow-x-auto pb-2 scrollbar-hide">
          {product.images.map((img, idx) => (
            <button
              ...
              className={`flex-shrink-0 w-20 h-20 sm:w-24 sm:h-24 rounded-2xl border-2 overflow-hidden bg-white p-2 transition-all ${activeImage === idx ? "border-stone-900" : "border-stone-200 hover:border-stone-400"
                }`}
            >
      ...
      <div className="flex flex-col pt-2 lg:pt-6">
          ...
          <div className="flex flex-wrap gap-3">
            {product.sizes.map((size) => (
              <button
                ...
                className={`px-6 py-3 rounded-full text-sm font-medium border transition-all ${selectedSize === size
        ...
        <div className="flex flex-col sm:flex-row gap-4 mb-12">
          ...
          <button
            ...
            className="flex-1 bg-teal-700 text-white px-8 py-4 rounded-full flex items-center justify-center gap-3 hover:bg-teal-800 transition-colors font-medium"
          >
